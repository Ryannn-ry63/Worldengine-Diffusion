...
from worldengine.components.agents.policy.pdm_planner.simulation.batch_kinematic_bicycle import (
    BatchKinematicBicycleModel,
)
from worldengine.components.agents.policy.pdm_planner.simulation.batch_lqr import (
    BatchLQRTracker,
)
...
class PDMSimulator:
    ...
    def simulate_proposals(
        self, states: npt.NDArray[np.float64], initial_ego_state: EgoState, batch_sim=False
