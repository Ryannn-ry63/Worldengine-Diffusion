"""
Define the parameter space of <observations> and <actions>.
...
from worldengine.utils.random_utils import get_np_random
...
class Space:
    ...
    Defines the basic observation and action space for environment.
    The space is defined by shape and dtype, and can support random
    sample by the sample function from seed.
    """
...
class Box(Space):
    """
    Parameter space in the multi-dimension format.
...
class Dict(Space):
    """
    Dictionary of observation or action spaces
    Copied from gym: gym/spaces/dict.py
...
# TODO: update the parameter space later.
#  To align with the nuplan space.
class Parameter:
    """
