"""
The base class for lane object.
"""
...
class BaseLane(WorldEngineObjectType):
    ...
    def __init__(self, lane_type=WorldEngineObjectType.LANE_SURFACE_STREET):
        super(BaseLane, self).__init__(lane_type)
    ...
    def is_previous_lane_of(self, target_lane, error_region=1e-1):
        ...
        if math.sqrt((x_1 - x_2) ** 2 + (y_1 - y_2) ** 2) < error_region:
            return True
        return False
