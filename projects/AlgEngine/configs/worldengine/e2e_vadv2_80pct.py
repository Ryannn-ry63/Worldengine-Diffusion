"""
Base IL Training (80%): Same as e2e_vadv2_50pct.py but with 80% NavSim training data.
Only difference: nav_filter_path_train -> navtrain_80pct.yaml.
...
nav_filter_path_train = "configs/navsim_splits/navtrain_split/navtrain_80pct.yaml"
...
load_from = os.path.join(WORLDENGINE_ROOT, "data/alg_engine/ckpts/track_map_nuplan_r50_navtrain_50pct_bs1x8.pth")
