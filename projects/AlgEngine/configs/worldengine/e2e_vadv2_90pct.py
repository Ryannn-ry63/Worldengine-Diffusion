"""
Base IL Training (90%): Same as e2e_vadv2_50pct.py but with 90% NavSim training data.
Only difference: nav_filter_path_train -> navtrain_90pct.yaml.
...
nav_filter_path_train = "configs/navsim_splits/navtrain_split/navtrain_90pct.yaml"
