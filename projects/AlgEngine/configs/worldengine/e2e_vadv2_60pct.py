"""
Base IL Training (60%): Same as e2e_vadv2_50pct.py but with 60% NavSim training data.
Only difference: nav_filter_path_train -> navtrain_60pct.yaml.
...
nav_filter_path_train = "configs/navsim_splits/navtrain_split/navtrain_60pct.yaml"
