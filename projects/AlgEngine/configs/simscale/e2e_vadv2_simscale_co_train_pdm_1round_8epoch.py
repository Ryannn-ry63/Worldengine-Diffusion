...
# Source code: https://github.com/OpenDriveLab/SimScale                              #
# Copyright (c) OpenDriveLab. All rights reserved.                                   #
# ---------------------------------------------------------------------------------- #

"""
SimScale Co-Train: cotrain with navtrain and simsale,.
Key: unfreeze bev, rl, no_is, no_imi for simsale.
"""
import os
...
# data path
train_dataset_type = "NavSimOpenSceneE2EFineTuneSimScale"  # NOTE: simscale dataset
...
nav_filter_path_train = "configs/navsim_splits/navtrain_split/navtrain.yaml"  # NOTE: 100%
...
# NOTE: finetune yaml files; optional
# finetune_yaml = [
...
model = dict(
    ...
    planning_head=dict(
        ...
        reward_shaping=True,
        rl_finetuning=True,
        importance_sampling=False, # NOTE no pretrain planner, set to False
        orig_IL=True,
        rl_loss_weight=dict(
            bce=0.0,
            rank=0.0,
...
data = dict(
    ...
    train=dict(
        ...
        # finetune_yaml=finetune_yaml, # NOTE: optional finetune yaml files
