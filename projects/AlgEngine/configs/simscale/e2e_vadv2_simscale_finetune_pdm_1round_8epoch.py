...
"""
SimScale Finetuning: finetune pretrained model on simsale, with same size normal data.
Key: freeze bev, lora, rl, no_imi for simsale
"""
import os
...
load_from = os.path.join(WORLDENGINE_ROOT, "data/alg_engine/ckpts/e2e_vadv2_ep8.pth")
