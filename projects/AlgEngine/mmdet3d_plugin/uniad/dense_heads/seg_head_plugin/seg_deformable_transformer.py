...
class SegDeformableTransformer(Transformer):
    ...
    def forward(
        ...
        **kwargs
        ...
        # decoder
        query = query.permute(1, 0, 2)      # 300 x 1 x 256
        memory = memory.permute(1, 0, 2)    # HW x 1 x 256
        query_pos = query_pos.permute(1, 0, 2)  # 300 x 1 x 256
        ...
        # inter_states: 6 x 300 x 1 x 256
        # inter_references: 6 x 300 x 1 x 4
