...
from mmdet3d_plugin.datasets.samplers.group_sampler import (
    DistributedGroupSampler,
)
from mmdet3d_plugin.datasets.samplers.distributed_sampler import (
    DistributedSampler,
)
...
def build_dataloader(
    ...
    **kwargs
    ...
    if dist:
        ...
        if shuffle:
            logger.info('Use shuffle sampler')
        ...
        warnings.warn("Only can be used for obtain inference speed!!!!")
    ...
    # print(f'\n\n\nworkers per gpu is {num_workers}')
