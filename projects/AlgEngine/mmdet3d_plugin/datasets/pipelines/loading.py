...
class LoadMultiViewImageFromFilesWithDownsample(object):
    ...
    def __call__(self, results):
        ...
        if self.downsample_factor != 1:
            ...
            results["cam_intrinsic"] = [scale_matrix[:3, :3] @ cam_intrinsic for cam_intrinsic in results["cam_intrinsic"]]
            if "cam_optim_intrinsic" in results:
                results["cam_optim_intrinsic"] = [scale_matrix[:3, :3] @ cam_optim_intrinsic for cam_optim_intrinsic in results["cam_optim_intrinsic"]]
